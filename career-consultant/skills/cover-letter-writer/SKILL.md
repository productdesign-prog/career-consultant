...
Only draft a letter for a vacancy that passed `job-match-scorer` at **≥ 80 with no hard-stop**, and after the user confirms. If it hasn't been scored, score it first or say why you're not writing yet. Use only facts present in the user's resume/profile — no invented motivation or claims.
